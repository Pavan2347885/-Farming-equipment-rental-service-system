...
<li><a href="#"><i class="fa fa-files-o"></i> Categorys</a>
<ul>
<li><a href="create-brand.php">Create Category</a></li>
<li><a href="manage-brands.php">Manage Category</a></li>
</ul>
</li>

<li><a href="#"><i class="fa fa-sitemap"></i> Machine</a>
					<ul>
						<li><a href="post-avehical.php">Post a Machine</a></li>
						<li><a href="manage-vehicles.php">Manage Machine</a></li>
					</ul>
				</li>
