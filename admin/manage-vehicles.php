...
<head>
	...
	<title>AgriServices |Admin Manage Vehicles   </title>
...
{				?>
		...
		<td>
<a href="manage-vehicles.php?del=<?php echo $result->id;?>" name="del" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
